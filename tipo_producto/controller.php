<?php
    ...
    function handler() {
        $event = GET_TIPO_PRODUCTO_LISTAR;
        $uri = $_SERVER['REQUEST_URI' ];
        $peticiones = array(GET_TIPO_PRODUCTO_LISTAR);
        ...
        switch ($event) {
            case GET_TIPO_PRODUCTO_LISTAR:
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    $data['listar_tipo_productos'] = render_table($perfil->gets());
                    

                    retornar_vista_dinamica(VIEW_TIPO_PRODUCTO_LISTAR,$data);
