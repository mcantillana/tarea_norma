<?php
    ...
    function handler() {
        $event = GET_PRODUCTO_LISTAR;
        $uri = $_SERVER['REQUEST_URI' ];
        $peticiones = array(GET_PRODUCTO_LISTAR);
        ...
        switch ($event) {
            case GET_PRODUCTO_LISTAR:
                ...
                if(isset($_SESSION['username'])) {
                    ...
                    $data['listar_productos'] = render_table($perfil->gets());
                    

                    retornar_vista_dinamica(VIEW_PRODUCTO_LISTAR,$data);
